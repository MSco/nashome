...
def main():
    ...
    parser.add_argument('start', metavar="start-template", type=Path, help="Path to the start template image file.")
    parser.add_argument('end', metavar="end-template", type=Path, help="Path to the end template image file.")
    ...
    cut_video(video_path=args.movie, 
              start_template_path=args.start, 
              end_template_path=args.end, 
              outdir=args.outdir, 

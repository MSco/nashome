...
def main():
    ...
    parser.add_argument('-l', "--language", type=str, default="de", help="If specified, the video will be re-dubbed with an extra audio stream in given language, if available (default: German).")
